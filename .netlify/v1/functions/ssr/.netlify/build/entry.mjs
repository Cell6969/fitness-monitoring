...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/weights.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/weight-tracker.astro",
...
var _page0 = () => import("./chunks/generic_BA6pR7l1.mjs");
var _page1 = () => import("./chunks/signin_DU53cMMx.mjs");
var _page2 = () => import("./chunks/signout_DVDuJM0f.mjs");
var _page3 = () => import("./chunks/weights_ByskPmE2.mjs");
var _page4 = () => import("./chunks/signin_m5cKUEgF.mjs");
var _page5 = () => import("./chunks/weight-tracker_CwV13q3c.mjs");
var _page6 = () => import("./chunks/index_B2G8K2EC.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/auth/signin.ts", _page1],
	["src/pages/api/auth/signout.ts", _page2],
	["src/pages/api/weights.ts", _page3],
	["src/pages/signin.astro", _page4],
	["src/pages/weight-tracker.astro", _page5],
	["src/pages/index.astro", _page6]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///D:/kerjaan/sidejob/diet/","cacheDir":"file:///D:/kerjaan/sidejob/diet/node_modules/.astro/","outDir":"file:///D:/kerjaan/sidejob/diet/dist/","srcDir":"file:///D:/kerjaan/sidejob/diet/src/","publicDir":"file:///D:/kerjaan/sidejob/diet/public/","buildClientDir":"file:///D:/kerjaan/sidejob/diet/dist/","buildServerDir":"file:///D:/kerjaan/sidejob/diet/.netlify/build/","adapterName":"@astrojs/netlify","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/signin","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/signin\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"signin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/signin.ts","pathname":"/api/auth/signin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/signout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/signout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"signout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/signout.ts","pathname":"/api/auth/signout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/weights","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/weights\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"weights","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/weights.ts","pathname":"/api/weights","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".signin-page[data-astro-cid-nv3kv2t6]{place-items:center;min-height:70vh;padding:32px 16px;display:grid}.signin-card[data-astro-cid-nv3kv2t6]{backdrop-filter:blur(8px);background:#fffffff2;border-radius:24px;width:min(100%,420px);padding:24px;box-shadow:0 16px 40px #58151c1f}.eyebrow[data-astro-cid-nv3kv2t6]{color:var(--primary);text-transform:uppercase;letter-spacing:.08em;margin:0 0 8px;font-size:.8rem;font-weight:700}h1[data-astro-cid-nv3kv2t6]{margin:0 0 8px;font-size:1.75rem}.subtext[data-astro-cid-nv3kv2t6]{color:var(--muted);margin:0 0 20px}.signin-form[data-astro-cid-nv3kv2t6]{flex-direction:column;gap:12px;display:flex}label[data-astro-cid-nv3kv2t6]{font-weight:600}input[data-astro-cid-nv3kv2t6]{font:inherit;border:1px solid #58151c24;border-radius:12px;padding:12px 14px}input[data-astro-cid-nv3kv2t6]:focus{border-color:var(--primary);outline:2px solid #fb71853d}button[data-astro-cid-nv3kv2t6]{background:var(--primary);color:#fff;cursor:pointer;border:none;border-radius:999px;margin-top:8px;padding:12px 14px;font-weight:700}button[data-astro-cid-nv3kv2t6]:hover{opacity:.92}\n:root{--primary:#fb7185;--bg:#fff7f9;--card:#fff;--text:#58151c;--muted:#6b7280}*{box-sizing:border-box}body{background:var(--bg);color:var(--text);-webkit-font-smoothing:antialiased;margin:0}html{scroll-behavior:smooth}a{color:var(--primary)}.container{max-width:1200px;margin:0 auto;padding:0 16px}button{font:inherit}.nav[data-astro-cid-l7arcky5]{backdrop-filter:blur(6px);z-index:50;background:#ffffffe6;position:fixed;top:0;left:0;right:0;box-shadow:0 2px 8px #0000000a}.nav[data-astro-cid-l7arcky5] .container[data-astro-cid-l7arcky5]{justify-content:space-between;align-items:center;gap:16px;max-width:1200px;margin:0 auto;padding:12px 16px;display:flex}.brand[data-astro-cid-l7arcky5]{color:var(--primary);font-weight:700;text-decoration:none}.nav-actions[data-astro-cid-l7arcky5]{align-items:center;gap:12px;display:flex}.links[data-astro-cid-l7arcky5]{gap:12px;margin:0;padding:0;list-style:none;display:flex}.links[data-astro-cid-l7arcky5] a[data-astro-cid-l7arcky5],.signin-link[data-astro-cid-l7arcky5]{color:var(--text);text-decoration:none}.auth-actions[data-astro-cid-l7arcky5]{align-items:center;gap:10px;display:flex}.user-pill[data-astro-cid-l7arcky5]{color:var(--primary);background:#fb71851f;border-radius:999px;padding:6px 10px;font-weight:600}.signout-form[data-astro-cid-l7arcky5]{display:flex}.signout-btn[data-astro-cid-l7arcky5],.signin-link[data-astro-cid-l7arcky5]{color:var(--primary);cursor:pointer;background:#fff;border:1px solid #fb718533;border-radius:999px;padding:7px 12px;font-weight:600;text-decoration:none}.signout-btn[data-astro-cid-l7arcky5]:hover,.signin-link[data-astro-cid-l7arcky5]:hover{background:#fb718514}@media (width<=600px){.links[data-astro-cid-l7arcky5]{display:none}.nav-actions[data-astro-cid-l7arcky5]{gap:8px}.user-pill[data-astro-cid-l7arcky5]{display:none}}.site-footer[data-astro-cid-jo6i4kqk]{text-align:center;color:var(--muted);background:0 0;padding:24px 0}.site-footer[data-astro-cid-jo6i4kqk] .inner[data-astro-cid-jo6i4kqk]{max-width:1200px;margin:0 auto}html,body{background-color:var(--bg);width:100%;height:100%;color:var(--text);margin:0;font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Helvetica Neue,Arial}main[data-astro-cid-ju4pidww]{min-height:calc(100vh - 160px);padding-top:72px}#background[data-astro-cid-ju4pidww]{z-index:-1;filter:blur(20px);width:100%;height:100%;position:fixed;top:0;left:0}.panda[data-astro-cid-ju4pidww]{z-index:60;pointer-events:none;width:350px;height:auto;position:fixed;bottom:12px;right:0}.toast-root[data-astro-cid-ju4pidww]{z-index:120;flex-direction:column;gap:8px;display:flex;position:fixed;bottom:16px;right:16px}.toast[data-astro-cid-ju4pidww]{color:#fff;opacity:0;background:#111827e6;border-radius:12px;min-width:220px;max-width:320px;padding:12px 14px;transition:all .22s;transform:translateY(8px);box-shadow:0 12px 28px #0000002e}.toast[data-astro-cid-ju4pidww].show{opacity:1;transform:translateY(0)}.toast-success[data-astro-cid-ju4pidww]{background:#166534f2}.toast-error[data-astro-cid-ju4pidww]{background:#b91c1cf2}\n"}],"routeData":{"route":"/signin","isIndex":false,"type":"page","pattern":"^\\/signin\\/?$","segments":[[{"content":"signin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/signin.astro","pathname":"/signin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".tracker-page[data-astro-cid-ykxceczc]{grid-template-columns:1.6fr 1fr;gap:24px;max-width:1200px;margin:0 auto;padding:32px 16px 64px;display:grid}.panel[data-astro-cid-ykxceczc]{background:#fffffff2;border-radius:24px;padding:24px;box-shadow:0 16px 40px #58151c1f}.panel-header[data-astro-cid-ykxceczc]{flex-wrap:wrap;justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:20px;display:flex}.panel-header[data-astro-cid-ykxceczc].compact{margin-bottom:16px}.eyebrow[data-astro-cid-ykxceczc]{color:var(--primary);text-transform:uppercase;letter-spacing:.08em;margin:0 0 6px;font-size:.8rem;font-weight:700}h1[data-astro-cid-ykxceczc],h2[data-astro-cid-ykxceczc]{margin:0 0 6px}.subtext[data-astro-cid-ykxceczc]{color:var(--muted);margin:0}.weight-form[data-astro-cid-ykxceczc]{flex-direction:column;gap:8px;min-width:220px;display:flex}.input-row[data-astro-cid-ykxceczc]{gap:8px;display:flex}.weight-form[data-astro-cid-ykxceczc] input[data-astro-cid-ykxceczc],.bmi-form[data-astro-cid-ykxceczc] input[data-astro-cid-ykxceczc]{width:100%;font:inherit;border:1px solid #58151c29;border-radius:12px;padding:10px 12px}.weight-form[data-astro-cid-ykxceczc] button[data-astro-cid-ykxceczc]{background:var(--primary);color:#fff;cursor:pointer;border:0;border-radius:12px;padding:10px 14px;font-weight:700}.modal-backdrop[data-astro-cid-ykxceczc]{z-index:100;background:#11182773;place-items:center;padding:16px;display:grid;position:fixed;inset:0}.modal-backdrop[data-astro-cid-ykxceczc].hidden{display:none}.modal-card[data-astro-cid-ykxceczc]{background:#fff;border-radius:18px;width:min(100%,360px);padding:20px;box-shadow:0 16px 40px #0003}.modal-card[data-astro-cid-ykxceczc] h3[data-astro-cid-ykxceczc]{margin:0 0 8px}.modal-card[data-astro-cid-ykxceczc] p[data-astro-cid-ykxceczc]{color:var(--muted);margin:0 0 14px}.modal-form[data-astro-cid-ykxceczc]{flex-direction:column;gap:12px;display:flex}.modal-form[data-astro-cid-ykxceczc] input[data-astro-cid-ykxceczc]{width:100%;font:inherit;border:1px solid #58151c29;border-radius:12px;padding:10px 12px}.modal-actions[data-astro-cid-ykxceczc]{justify-content:flex-end;gap:8px;display:flex}.modal-actions[data-astro-cid-ykxceczc] button[data-astro-cid-ykxceczc]{cursor:pointer;border:0;border-radius:999px;padding:8px 12px;font-weight:700}.modal-actions[data-astro-cid-ykxceczc] button[data-astro-cid-ykxceczc][type=submit]{background:var(--primary);color:#fff}.secondary-btn[data-astro-cid-ykxceczc]{color:#374151;background:#f3f4f6}.table-card[data-astro-cid-ykxceczc]{border:1px solid #58151c14;border-radius:16px;overflow:hidden}.table-header[data-astro-cid-ykxceczc]{background:#fb718514;justify-content:space-between;align-items:center;padding:14px 16px;display:flex}.table-wrap[data-astro-cid-ykxceczc]{overflow-x:auto}table[data-astro-cid-ykxceczc]{border-collapse:collapse;width:100%}th[data-astro-cid-ykxceczc],td[data-astro-cid-ykxceczc]{text-align:left;border-bottom:1px solid #58151c14;padding:12px 16px}th[data-astro-cid-ykxceczc]{background:#fffc;font-size:.95rem}.edit-btn[data-astro-cid-ykxceczc]{color:var(--primary);cursor:pointer;background:#fff;border:1px solid #fb718533;border-radius:999px;padding:6px 10px;font-weight:600}.pagination[data-astro-cid-ykxceczc]{justify-content:flex-end;gap:8px;padding:14px 16px;display:flex}.page-btn[data-astro-cid-ykxceczc]{cursor:pointer;background:#fff;border:1px solid #58151c29;border-radius:999px;padding:6px 10px}.page-btn[data-astro-cid-ykxceczc].active{background:var(--primary);color:#fff;border-color:var(--primary)}.page-btn[data-astro-cid-ykxceczc]:disabled{opacity:.4;cursor:not-allowed}.bmi-form[data-astro-cid-ykxceczc]{flex-direction:column;gap:10px;display:flex}.bmi-result[data-astro-cid-ykxceczc]{color:#881337;background:#fb71851a;border-radius:14px;justify-content:space-between;align-items:center;gap:12px;padding:14px;font-weight:700;display:flex}@media (width<=900px){.tracker-page[data-astro-cid-ykxceczc]{grid-template-columns:1fr}}\n:root{--primary:#fb7185;--bg:#fff7f9;--card:#fff;--text:#58151c;--muted:#6b7280}*{box-sizing:border-box}body{background:var(--bg);color:var(--text);-webkit-font-smoothing:antialiased;margin:0}html{scroll-behavior:smooth}a{color:var(--primary)}.container{max-width:1200px;margin:0 auto;padding:0 16px}button{font:inherit}.nav[data-astro-cid-l7arcky5]{backdrop-filter:blur(6px);z-index:50;background:#ffffffe6;position:fixed;top:0;left:0;right:0;box-shadow:0 2px 8px #0000000a}.nav[data-astro-cid-l7arcky5] .container[data-astro-cid-l7arcky5]{justify-content:space-between;align-items:center;gap:16px;max-width:1200px;margin:0 auto;padding:12px 16px;display:flex}.brand[data-astro-cid-l7arcky5]{color:var(--primary);font-weight:700;text-decoration:none}.nav-actions[data-astro-cid-l7arcky5]{align-items:center;gap:12px;display:flex}.links[data-astro-cid-l7arcky5]{gap:12px;margin:0;padding:0;list-style:none;display:flex}.links[data-astro-cid-l7arcky5] a[data-astro-cid-l7arcky5],.signin-link[data-astro-cid-l7arcky5]{color:var(--text);text-decoration:none}.auth-actions[data-astro-cid-l7arcky5]{align-items:center;gap:10px;display:flex}.user-pill[data-astro-cid-l7arcky5]{color:var(--primary);background:#fb71851f;border-radius:999px;padding:6px 10px;font-weight:600}.signout-form[data-astro-cid-l7arcky5]{display:flex}.signout-btn[data-astro-cid-l7arcky5],.signin-link[data-astro-cid-l7arcky5]{color:var(--primary);cursor:pointer;background:#fff;border:1px solid #fb718533;border-radius:999px;padding:7px 12px;font-weight:600;text-decoration:none}.signout-btn[data-astro-cid-l7arcky5]:hover,.signin-link[data-astro-cid-l7arcky5]:hover{background:#fb718514}@media (width<=600px){.links[data-astro-cid-l7arcky5]{display:none}.nav-actions[data-astro-cid-l7arcky5]{gap:8px}.user-pill[data-astro-cid-l7arcky5]{display:none}}.site-footer[data-astro-cid-jo6i4kqk]{text-align:center;color:var(--muted);background:0 0;padding:24px 0}.site-footer[data-astro-cid-jo6i4kqk] .inner[data-astro-cid-jo6i4kqk]{max-width:1200px;margin:0 auto}html,body{background-color:var(--bg);width:100%;height:100%;color:var(--text);margin:0;font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Helvetica Neue,Arial}main[data-astro-cid-ju4pidww]{min-height:calc(100vh - 160px);padding-top:72px}#background[data-astro-cid-ju4pidww]{z-index:-1;filter:blur(20px);width:100%;height:100%;position:fixed;top:0;left:0}.panda[data-astro-cid-ju4pidww]{z-index:60;pointer-events:none;width:350px;height:auto;position:fixed;bottom:12px;right:0}.toast-root[data-astro-cid-ju4pidww]{z-index:120;flex-direction:column;gap:8px;display:flex;position:fixed;bottom:16px;right:16px}.toast[data-astro-cid-ju4pidww]{color:#fff;opacity:0;background:#111827e6;border-radius:12px;min-width:220px;max-width:320px;padding:12px 14px;transition:all .22s;transform:translateY(8px);box-shadow:0 12px 28px #0000002e}.toast[data-astro-cid-ju4pidww].show{opacity:1;transform:translateY(0)}.toast-success[data-astro-cid-ju4pidww]{background:#166534f2}.toast-error[data-astro-cid-ju4pidww]{background:#b91c1cf2}\n"}],"routeData":{"route":"/weight-tracker","isIndex":false,"type":"page","pattern":"^\\/weight-tracker\\/?$","segments":[[{"content":"weight-tracker","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/weight-tracker.astro","pathname":"/weight-tracker","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"#hero[data-astro-cid-ge2uvauf] .inner[data-astro-cid-ge2uvauf]{text-align:center;background:#ffffffe6;border-radius:12px;max-width:900px;margin:48px auto;padding:24px;box-shadow:0 6px 18px #00000014}#hero[data-astro-cid-ge2uvauf] h1[data-astro-cid-ge2uvauf]{color:#b91c1c;margin:0 0 8px;font-size:28px}#hero[data-astro-cid-ge2uvauf] p[data-astro-cid-ge2uvauf]{color:#7f1d1d;margin:0 0 16px}.cta-group[data-astro-cid-ge2uvauf]{flex-wrap:wrap;justify-content:center;gap:12px;display:flex}#hero[data-astro-cid-ge2uvauf] .cta[data-astro-cid-ge2uvauf]{color:#fff;background:#fb7185;border-radius:10px;padding:10px 16px;font-weight:600;text-decoration:none;display:inline-block}#hero[data-astro-cid-ge2uvauf] .cta[data-astro-cid-ge2uvauf].secondary{color:#be123c;background:#fff;border:1px solid #be123c33}#meals[data-astro-cid-nxsfgbym]{max-width:1200px;margin:24px auto;padding:0 16px}#meals[data-astro-cid-nxsfgbym] h2[data-astro-cid-nxsfgbym]{color:#b91c1c}.week-grid[data-astro-cid-nxsfgbym]{grid-template-columns:repeat(2,1fr);gap:12px;display:grid}.day-card[data-astro-cid-nxsfgbym]{opacity:0;background:#fff;border-radius:12px;padding:12px;transition:opacity .32s,transform .32s;transform:translateY(8px);box-shadow:0 6px 18px #0000000f}.day-card[data-astro-cid-nxsfgbym].in-view{opacity:1;transform:none}.day-card[data-astro-cid-nxsfgbym] h3[data-astro-cid-nxsfgbym]{margin:0 0 8px}.day-total[data-astro-cid-nxsfgbym]{color:#111827;margin:6px 0 2px;font-weight:700}.day-subtotal[data-astro-cid-nxsfgbym]{color:#6b7280;margin:0 0 8px}dl[data-astro-cid-nxsfgbym]{margin:0}dt[data-astro-cid-nxsfgbym]{color:#374151;margin-top:8px;font-weight:600}dd[data-astro-cid-nxsfgbym]{border-bottom:1px dashed #f3f4f6;justify-content:space-between;margin:6px 0;padding-bottom:6px;display:flex}dd[data-astro-cid-nxsfgbym]:last-of-type{border-bottom:none}.name[data-astro-cid-nxsfgbym]{color:#111827}.cal[data-astro-cid-nxsfgbym]{color:#6b7280}@media (width<=1100px){.week-grid[data-astro-cid-nxsfgbym]{grid-template-columns:repeat(2,1fr)}}@media (width<=700px){.week-grid[data-astro-cid-nxsfgbym]{grid-template-columns:repeat(2,1fr)}}@media (width<=420px){.week-grid[data-astro-cid-nxsfgbym]{grid-template-columns:1fr}}#activities[data-astro-cid-7pfinimb]{max-width:900px;margin:24px auto;padding:0 16px}.activities[data-astro-cid-7pfinimb]{gap:8px;margin:0;padding:0;list-style:none;display:grid}.activities[data-astro-cid-7pfinimb] li[data-astro-cid-7pfinimb]{background:#fff;border-radius:10px;padding:10px;box-shadow:0 6px 12px #0000000a}.activities[data-astro-cid-7pfinimb] label[data-astro-cid-7pfinimb]{align-items:center;gap:12px;display:flex}.activities[data-astro-cid-7pfinimb] .title[data-astro-cid-7pfinimb]{font-weight:600}.activities[data-astro-cid-7pfinimb] .desc[data-astro-cid-7pfinimb]{color:#6b7280;margin:4px 0 0;font-size:14px}#tips[data-astro-cid-shfqedvn]{max-width:900px;margin:24px auto;padding:0 16px}.tips[data-astro-cid-shfqedvn]{gap:8px;padding:0;list-style:none;display:grid}.tips[data-astro-cid-shfqedvn] li[data-astro-cid-shfqedvn]{background:#fff;border-radius:10px;padding:12px;box-shadow:0 6px 12px #0000000a}#faq[data-astro-cid-7synugci]{max-width:900px;margin:24px auto;padding:0 16px}.faqs[data-astro-cid-7synugci]{gap:8px;display:grid}.item[data-astro-cid-7synugci] details[data-astro-cid-7synugci]{background:#fff;border-radius:10px;padding:12px;box-shadow:0 6px 12px #0000000a}.item[data-astro-cid-7synugci] summary[data-astro-cid-7synugci]{cursor:pointer;font-weight:600}.item[data-astro-cid-7synugci] p[data-astro-cid-7synugci]{color:#6b7280;margin:8px 0 0}\n:root{--primary:#fb7185;--bg:#fff7f9;--card:#fff;--text:#58151c;--muted:#6b7280}*{box-sizing:border-box}body{background:var(--bg);color:var(--text);-webkit-font-smoothing:antialiased;margin:0}html{scroll-behavior:smooth}a{color:var(--primary)}.container{max-width:1200px;margin:0 auto;padding:0 16px}button{font:inherit}.nav[data-astro-cid-l7arcky5]{backdrop-filter:blur(6px);z-index:50;background:#ffffffe6;position:fixed;top:0;left:0;right:0;box-shadow:0 2px 8px #0000000a}.nav[data-astro-cid-l7arcky5] .container[data-astro-cid-l7arcky5]{justify-content:space-between;align-items:center;gap:16px;max-width:1200px;margin:0 auto;padding:12px 16px;display:flex}.brand[data-astro-cid-l7arcky5]{color:var(--primary);font-weight:700;text-decoration:none}.nav-actions[data-astro-cid-l7arcky5]{align-items:center;gap:12px;display:flex}.links[data-astro-cid-l7arcky5]{gap:12px;margin:0;padding:0;list-style:none;display:flex}.links[data-astro-cid-l7arcky5] a[data-astro-cid-l7arcky5],.signin-link[data-astro-cid-l7arcky5]{color:var(--text);text-decoration:none}.auth-actions[data-astro-cid-l7arcky5]{align-items:center;gap:10px;display:flex}.user-pill[data-astro-cid-l7arcky5]{color:var(--primary);background:#fb71851f;border-radius:999px;padding:6px 10px;font-weight:600}.signout-form[data-astro-cid-l7arcky5]{display:flex}.signout-btn[data-astro-cid-l7arcky5],.signin-link[data-astro-cid-l7arcky5]{color:var(--primary);cursor:pointer;background:#fff;border:1px solid #fb718533;border-radius:999px;padding:7px 12px;font-weight:600;text-decoration:none}.signout-btn[data-astro-cid-l7arcky5]:hover,.signin-link[data-astro-cid-l7arcky5]:hover{background:#fb718514}@media (width<=600px){.links[data-astro-cid-l7arcky5]{display:none}.nav-actions[data-astro-cid-l7arcky5]{gap:8px}.user-pill[data-astro-cid-l7arcky5]{display:none}}.site-footer[data-astro-cid-jo6i4kqk]{text-align:center;color:var(--muted);background:0 0;padding:24px 0}.site-footer[data-astro-cid-jo6i4kqk] .inner[data-astro-cid-jo6i4kqk]{max-width:1200px;margin:0 auto}html,body{background-color:var(--bg);width:100%;height:100%;color:var(--text);margin:0;font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Helvetica Neue,Arial}main[data-astro-cid-ju4pidww]{min-height:calc(100vh - 160px);padding-top:72px}#background[data-astro-cid-ju4pidww]{z-index:-1;filter:blur(20px);width:100%;height:100%;position:fixed;top:0;left:0}.panda[data-astro-cid-ju4pidww]{z-index:60;pointer-events:none;width:350px;height:auto;position:fixed;bottom:12px;right:0}.toast-root[data-astro-cid-ju4pidww]{z-index:120;flex-direction:column;gap:8px;display:flex;position:fixed;bottom:16px;right:16px}.toast[data-astro-cid-ju4pidww]{color:#fff;opacity:0;background:#111827e6;border-radius:12px;min-width:220px;max-width:320px;padding:12px 14px;transition:all .22s;transform:translateY(8px);box-shadow:0 12px 28px #0000002e}.toast[data-astro-cid-ju4pidww].show{opacity:1;transform:translateY(0)}.toast-success[data-astro-cid-ju4pidww]{background:#166534f2}.toast-error[data-astro-cid-ju4pidww]{background:#b91c1cf2}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/kerjaan/sidejob/diet/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/kerjaan/sidejob/diet/src/pages/signin.astro",{"propagation":"none","containsHead":true}],["D:/kerjaan/sidejob/diet/src/pages/weight-tracker.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.DJBYoHAJ.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_UK25_e1N.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/netlify/ssr-function.js":"entry.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_BA6pR7l1.mjs","D:/kerjaan/sidejob/diet/node_modules/@astrojs/netlify/dist/image-service.js":"chunks/image-service_DdQd_4Yg.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_B2G8K2EC.mjs","\u0000virtual:astro:page:src/pages/api/auth/signin@_@ts":"chunks/signin_DU53cMMx.mjs","\u0000virtual:astro:page:src/pages/signin@_@astro":"chunks/signin_m5cKUEgF.mjs","\u0000virtual:astro:page:src/pages/api/auth/signout@_@ts":"chunks/signout_DVDuJM0f.mjs","\u0000virtual:astro:page:src/pages/weight-tracker@_@astro":"chunks/weight-tracker_CwV13q3c.mjs","\u0000virtual:astro:page:src/pages/api/weights@_@ts":"chunks/weights_ByskPmE2.mjs","D:/kerjaan/sidejob/diet/src/components/MealCard.astro?astro&type=script&index=0&lang.ts":"_astro/MealCard.astro_astro_type_script_index_0_lang.DFNQJOsm.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/kerjaan/sidejob/diet/src/components/MealCard.astro?astro&type=script&index=0&lang.ts","(()=>{if(typeof window>`u`)return;document.documentElement.style.scrollBehavior=`smooth`;let e=new IntersectionObserver(e=>{for(let t of e)t.isIntersecting&&t.target.classList.add(`in-view`)},{threshold:.12});for(let t of document.querySelectorAll(`.day-card`))e.observe(t)})();"]],"assets":["/favicon.ico","/favicon.svg","/_astro/panda.BleqkQJA.png","/_astro/background.BPKAcmfN.svg"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"X9IBY+9moFhP72gVfToo3nBbdYu3Po5Thkb3Ji592LA=","sessionConfig":{"driver":"unstorage/drivers/netlify-blobs","options":{"name":"astro-sessions","consistency":"strong"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function createHandler({ notFoundContent }) {
	return async function handler(request, context) {
		...
		if (astroLocalsHeader) {
			if (middlewareSecretHeader !== "8c453d6b-7558-4097-bac6-f58e31187358") return new Response("Forbidden", { status: 403 });
